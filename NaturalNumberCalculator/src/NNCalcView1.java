...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
        ...
        //Enter each operator button individually
        ...
        //Create array for the digit buttons
        ...
        //Create new scrollPane object
        JScrollPane scrollToTTop = new JScrollPane(this.tTop);
        JScrollPane scrollToTBottom = new JScrollPane(this.tBottom);
        ...
        JPanel allButtonPanel = new JPanel(new FlowLayout());

        /*
         * Add the other two button panels to the combined button panel
         */

        allButtonPanel.add(mainButtonPanel);
        allButtonPanel.add(sideButtonPanel);
        ...
        this.add(scrollToTTop);
        this.add(scrollToTBottom);
        this.add(allButtonPanel);
